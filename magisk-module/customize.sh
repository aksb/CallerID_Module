...
ui_print "- Aksb2026CallerID 保活助手"
ui_print "  纯脚本模块，不含 APK，只有装了 com.aksb2026.callerid.module 这个包名的 App"
...
if pm path com.aksb2026.callerid.module >/dev/null 2>&1; then
    ui_print "- 检测到已安装 com.aksb2026.callerid.module，重启后即会自动生效"
else
    ui_print "- 当前还没有安装 com.aksb2026.callerid.module，之后装了这个包名后重启一次即可生效"
fi
