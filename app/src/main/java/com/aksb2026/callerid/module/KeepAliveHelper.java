 ...
 *
 * v4.9 补充：libsu 依赖又加回来了，但不是恢复 v4.0 那种默认路径——是作为
 * "Root保活教程"里一个刻意不显眼、默认关闭、需要用户主动看完风险声明并
 * 勾选"已知悉风险"才能打开的"⑤ 高级选项"重新引入，见 RootAdvancedHelper.java。
 * 上面这几段"为什么 v4.1 要去掉"的理由依然全部成立，v4.9 只是多给了一条
 * "愿意自己承担后果的高级用户可以选择开启"的路，默认路径没有变。
 *
